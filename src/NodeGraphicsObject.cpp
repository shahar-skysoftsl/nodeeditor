...
NodeGraphicsObject::NodeGraphicsObject(AbstractQGraphicsScene &scene, NodeId nodeId)
    : AbstractNodeGraphicsObject(scene, nodeId)
...
void NodeGraphicsObject::reactToConnection(AbstractConnectionGraphicsObject const *cgo)
{
